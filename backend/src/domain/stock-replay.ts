 ...
 */
import { applyMovement, type MovementInput, type StockState } from "./costing.ts";
...
export function replay(rows: readonly LedgerRow[]): StockState {
  ...
  return ordered.reduce<StockState>((s, r) => applyMovement(s, r), { stockQty: 0, avgCostMdram: null });
}
